...
public class SHForceDB extends SQLiteOpenHelper {
    ...
    public SHForceDB(Context context) {
        super(context, "SHForceSave.db", null, 1);
    }
    //创建table
    @Override
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE " + "SHForceSave" + " (" + "id"+
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String sql = "DROP TABLE IF EXISTS " + "SHForceSave";
        db.execSQL(sql);
        onCreate(db);
    }
    public Cursor select() {
        ...
        Cursor cursor = db
                .query("SHForceSave", null, null, null, null, null, null);
        return cursor;
    }
    //增加操作
    public long insert(String str_date,String str_forceMax)
    {
        ...
        long row = db.insert("SHForceSave", null, cv);
        return row;
    }
    //删除操作
    public void delete(int id)
    {
        ...
        db.delete("SHForceSave", where, whereValue);
    }
    //修改操作
    public void update(int id)
    {
        ...
        db.update("SHForceSave", cv, where, whereValue);
    }
