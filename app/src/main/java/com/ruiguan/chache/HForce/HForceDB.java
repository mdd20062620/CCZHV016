...
public class HForceDB extends SQLiteOpenHelper {
    private String str_company;
    private String str_number;
    private String str_chacheNumber;
    private String str_chacheType;
    private String str_chacheGroup;
    public HForceDB(Context context) {
        super(context, "HForceSave.db", null, 1);
    }
    //创建table
    @Override
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE " + "HForceSave" + " (" + "id"+
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String sql = "DROP TABLE IF EXISTS " + "HForceSave";
        db.execSQL(sql);
        onCreate(db);
    }
    public Cursor select() {
        ...
        Cursor cursor = db
                .query("HForceSave", null, null, null, null, null, null);
        return cursor;
    }
    //增加操作
    public long insert(String str_date,String str_forceMax)
    {
        ...
        long row = db.insert("HForceSave", null, cv);
        return row;
    }
    //删除操作
    public void delete(int id)
    {
        ...
        db.delete("HForceSave", where, whereValue);
    }
    //修改操作
    public void update(int id)
    {
        ...
        db.update("HForceSave", cv, where, whereValue);
    }
